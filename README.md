# Evanns Morales-Cuadrado · [@evannsmc](https://evannsmc.com)

> Robotics & ECE Ph.D student at Georgia Tech · Safe autonomy, nonlinear control, quadrotor UAVs
> Personal site & portfolio: **[evannsmc](https://evannsmc.com)**
...
My robotics work centers around hardware applications (usually on quadrotors) of safe autonomous control algorithms.<br><br>
...
| Project | Description |
|---|---|
| [**`RTD-RAX`**](https://github.com/evannsm/rtd-rax) | Safe trajectory planning with runtime reachability verification via [immrax](https://github.com/gtfactslab/immrax) — plans with a less-conservative FRS, verifies candidates under measured disturbance bounds, and repairs unsafe trajectories online. [Docs](https://evannsm.github.io/ws_RTD) |
